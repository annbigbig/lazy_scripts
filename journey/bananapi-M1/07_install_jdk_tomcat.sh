...
install_jdk() {
	...
	rm -rf ./jdk-8u91-linux-arm32-vfp-hflt.tar.gz
...
install_tomcat() {
	...
	echo -e "fix [fatal error: jni_md.h: No such file or directory] \n"
        ln -s /usr/local/jdk/include/linux/jni_md.h /usr/local/jdk/include/jni_md.h
        ln -s /usr/local/jdk/include/linux/jawt_md.h /usr/local/jdk/include/jawt_md.h
