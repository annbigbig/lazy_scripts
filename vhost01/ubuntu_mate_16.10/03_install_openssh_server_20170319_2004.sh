#!/bin/bash
#
# This script will install openssh-server on Ubuntu 16.04.02 LTS
...
# you could find it at your local computer's /home/$USER/.ssh/id_rsa.pub
#
...
main() {
	...
	echo -e " \n"
	echo -e " \n"
	echo -e "then issue command 'ssh vhost01' for connecting to openssh server\n"
}
