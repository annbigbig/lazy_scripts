...
# 
##########################################################################################################################################
YOUR_SSL_CERT_PATH="/opt/fullchain.pem"                # place your domain's SSL cert here , owner/group == root , permission == 0644
YOUR_SSL_KEY_PATH="/opt/privkey.pem"                   # place your domain's SSL cert key here , owner/group == root , permission == 0600
